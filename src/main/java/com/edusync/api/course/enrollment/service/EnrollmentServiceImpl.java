...
public class EnrollmentServiceImpl implements EnrollmentService {
    ...
    @Override
    public EnrollmentResponse enrollStudentInCourse(UUID courseUuid, EnrollmentRequest.Enroll request) {
        var course = courseService.findCourseEntityByUuid(courseUuid);
    ...
    public Page<EnrollmentResponse> findAllEnrollmentsByCourse(UUID courseUuid, EnrollmentStatus status, Boolean blocked, Pageable pageable) {
        var course = courseService.findCourseEntityByUuid(courseUuid);
    ...
    @Override
    public EnrollmentResponse withdrawStudentFromCourse(UUID courseUuid, UUID studentUuid, EnrollmentRequest.Withdraw request) {
    ...
    @Override
    public EnrollmentResponse blockEnrollment(UUID courseUuid, UUID studentUuid, EnrollmentRequest.Block request, Long blockedById) {
        var enrollment = findEnrollment(courseUuid, studentUuid);
    ...
    @Override
    public EnrollmentResponse unblockEnrollment(UUID courseUuid, UUID studentUuid) {
        var enrollment = findEnrollment(courseUuid, studentUuid);
