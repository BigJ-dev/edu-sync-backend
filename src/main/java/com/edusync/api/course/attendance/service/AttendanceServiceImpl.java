...
public class AttendanceServiceImpl implements AttendanceService {
    ...
    @Override
    public AttendanceResponse recordAttendance(UUID sessionUuid, AttendanceRequest.Record request) {
        var session = classSessionService.findClassSessionEntityByUuid(sessionUuid);
    ...
    public List<AttendanceResponse> findAllAttendanceBySession(UUID sessionUuid, AttendanceStatus status) {
        var session = classSessionService.findClassSessionEntityByUuid(sessionUuid);
    ...
    @Override
    public AttendanceResponse overrideAttendance(UUID sessionUuid, UUID studentUuid, AttendanceRequest.Override request) {
        var session = classSessionService.findClassSessionEntityByUuid(sessionUuid);
