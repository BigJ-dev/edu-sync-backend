...
@Transactional
public class RubricGradeServiceImpl implements RubricGradeService {
    ...
    @Override
    public RubricGradeResponse awardRubricGrade(UUID submissionUuid, UUID criteriaUuid, RubricGradeRequest.Award request) {
        var submission = submissionService.findSubmissionEntityByUuid(submissionUuid);
        var criteria = rubricCriteriaService.findRubricCriteriaEntityByUuid(criteriaUuid);
    ...
    public List<RubricGradeResponse> findAllRubricGradesBySubmission(UUID submissionUuid) {
        var submission = submissionService.findSubmissionEntityByUuid(submissionUuid);
