...
public class SubmissionServiceImpl implements SubmissionService {
    ...
    @Override
    public SubmissionResponse submitAssessment(UUID assessmentUuid, SubmissionRequest.Submit request) {
    ...
    public List<SubmissionResponse> findAllSubmissionsByAssessment(UUID assessmentUuid, SubmissionStatus status, Boolean late) {
        var assessment = assessmentService.findAssessmentEntityByUuid(assessmentUuid);
    ...
    @Override
    @Transactional(readOnly = true)
    public SubmissionResponse findSubmissionByUuid(UUID submissionUuid) {
        return SubmissionResponse.from(findSubmissionEntityByUuid(submissionUuid));
    }

    @Override
    public SubmissionResponse gradeSubmission(UUID submissionUuid, SubmissionRequest.Grade request) {
        var submission = findSubmissionEntityByUuid(submissionUuid);
    ...
    @Override
    public SubmissionResponse returnSubmissionForResubmission(UUID submissionUuid, SubmissionRequest.Return request) {
        var submission = findSubmissionEntityByUuid(submissionUuid);
        submission.setFeedback(request.feedback());
    ...
    @Override
    public AssessmentSubmission findSubmissionEntityByUuid(UUID uuid) {
