...
public class ModuleServiceImpl implements ModuleService {
    ...
    @Override
    public ModuleResponse createModule(UUID courseUuid, ModuleRequest.Create request) {
    ...
    public List<ModuleResponse> findAllModulesByCourse(UUID courseUuid, ModuleStatus status, String search) {
        var course = courseService.findCourseEntityByUuid(courseUuid);
    ...
    @Override
    @Transactional(readOnly = true)
    public ModuleResponse findModuleByUuid(UUID moduleUuid) {
        return ModuleResponse.from(findModule(moduleUuid));
    }

    @Override
    public ModuleResponse updateModule(UUID moduleUuid, ModuleRequest.Update request) {
    ...
    @Override
    public ModuleResponse updateModuleStatus(UUID moduleUuid, ModuleRequest.UpdateStatus request) {
        var module = findModule(moduleUuid);
