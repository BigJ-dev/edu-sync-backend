...
public class AppUserService {
    ...
    public AppUserResponse create(AppUserRequest.Create request, UserRole role) {
    ...
    public Page<AppUserResponse> findAll(UserRole role, Boolean active, String search, Pageable pageable) {
    ...
    @Transactional(readOnly = true)
    public AppUserResponse findByUuid(UUID uuid, UserRole role) {
        return AppUserResponse.from(findUser(uuid, role));
    }

    public AppUserResponse update(UUID uuid, AppUserRequest.Update request, UserRole role) {
    ...
    public AppUserResponse block(UUID uuid, AppUserRequest.Block request, Long blockedById, UserRole role) {
        var user = findUser(uuid, role);
    ...
    public AppUserResponse unblock(UUID uuid, UserRole role) {
        var user = findUser(uuid, role);
        user.setActive(true);
    ...
    @Transactional(readOnly = true)
    public AppUserResponse findByCognitoSub(String cognitoSub, UserRole role) {
